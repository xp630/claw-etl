      ...
      <form onSubmit={handleSubmit} className="space-y-4 max-w-2xl">
        <div className="bg-slate-800/30 rounded-lg border border-slate-700/50 p-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm text-slate-400 mb-1">字典编码</label>
              <input
                type="text"
                value={formData.code || ''}
            ...
            <div>
              <label className="block text-sm text-slate-400 mb-1">字典名称</label>
              <input
                type="text"
                value={formData.name || ''}
        ...
        <div className="bg-slate-800/30 rounded-lg border border-slate-700/50 p-4">
          <div className="flex items-center justify-between mb-3">
            <h2 className="text-sm font-semibold text-white">字典项</h2>
          </div>
          ...
          <div className="mb-3 flex gap-2">
            <input
              ...
              className="flex-1 px-3 py-2 bg-slate-800/50 border border-slate-700/50 rounded-lg text-white text-sm focus:outline-none focus:border-purple-500/50"
            />
            <input
              type="text"
              placeholder="值"
            ...
            <button
              ...
              className="px-3 py-2 bg-purple-500/20 hover:bg-purple-500/30 text-purple-400 rounded-lg transition-colors text-sm"
            >
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-slate-700/50">
                <th className="px-3 py-2 text-left text-xs font-medium text-slate-400">排序</th>
                <th className="px-3 py-2 text-left text-xs font-medium text-slate-400">标签</th>
                <th className="px-3 py-2 text-left text-xs font-medium text-slate-400">值</th>
                  ...
                  <tr key={index} className="border-b border-slate-700/30">
                    <td className="px-3 py-2">
                      <input
                        ...
                        className="w-16 px-2 py-1 bg-slate-800/50 border border-slate-700/50 rounded text-white text-xs text-center focus:outline-none focus:border-purple-500/50"
                      />
                    </td>
                    <td className="px-3 py-2">
                      <input
