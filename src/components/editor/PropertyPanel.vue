            ...
            <div class="tab-config-content">
              ...
              <div class="bg-[var(--bg-hover-light)] rounded p-2 mb-3">
                <div class="flex items-center gap-3 text-xs">
                  <span class="text-[var(--text-muted)] font-medium shrink-0">布局:</span>
                  <label class="flex items-center gap-1">
                    <span class="text-[var(--text-muted)]">方向</span>
                    <select
                      :value="tab.layout?.direction || 'column'"
                      class="px-1 py-0.5 border border-[var(--border)] rounded text-xs bg-[var(--bg-primary)]"
                  ...
                  <label class="flex items-center gap-1">
                    <span class="text-[var(--text-muted)]">间距</span>
                    <input
                      :value="tab.layout?.gap ?? 8"
                      type="number"
                      class="w-12 px-1 py-0.5 border border-[var(--border)] rounded text-xs bg-[var(--bg-primary)]"
                      min="0"
                      @input="updateTabLayout(index, 'gap', Number(($event.target as HTMLInputElement).value))"
                    />
                  </label>
                  <label class="flex items-center gap-1">
                    <span class="text-[var(--text-muted)]">对齐</span>
                    <select
                  ...
                  <label class="flex items-center gap-1">
                    ...
                    />
                    <span class="text-[var(--text-muted)]">换行</span>
                  </label>
                </div>
              </div>
              ...
              <div class="bg-[var(--bg-hover-light)] rounded p-2">
                <div class="flex items-center justify-between mb-2">
                  <span class="text-xs text-[var(--text-muted)] font-medium">参数</span>
                  <button
                    type="button"
                    class="text-xs text-[var(--accent)] hover:underline"
                ...
                <div class="space-y-1">
                  ...
                  >
                    <input
                      :value="paramKey"
                      type="text"
                      class="w-20 px-1 py-0.5 border border-[var(--border)] rounded text-xs bg-[var(--bg-primary)]"
                      placeholder="key"
                    ...
                    <input
                      :value="paramVal"
                      type="text"
                      class="flex-1 px-1 py-0.5 border border-[var(--border)] rounded text-xs bg-[var(--bg-primary)]"
                      placeholder="value"
...
.tabs-flat-tabs :deep(.el-tabs__header) {
  margin-bottom: 8px;
}

.tabs-flat-tabs :deep(.el-tabs__nav) {
  border-radius: 4px;
}

.tabs-flat-tabs :deep(.el-tabs__item) {
  font-size: 12px;
  padding: 0 12px;
  height: 32px;
  line-height: 32px;
...
.tabs-flat-tabs :deep(.el-tabs__content) {
  padding: 0;
}
